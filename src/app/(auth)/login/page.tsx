      ...
      <Container className="relative z-10">
        <SlideUp>
          <div className="mx-auto max-w-md">
            ...
            <form action={signInWithMagicLink} className="space-y-6 bg-zinc-950 p-8 rounded-3xl border border-white/5 shadow-2xl">
              <div>
              ...
              <Button type="submit" className="w-full h-12 bg-zinc-100 text-zinc-900 hover:bg-zinc-300 transition-colors font-medium">
                Continue with Email
              </Button>
            </form>
          </div>
